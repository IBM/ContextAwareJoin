...
class GloveTransformer:
    ...
    def _download_model(self,
        ...
        if os.path.isfile(file_name):
            if if_exists == "ignore":
                ...
                logger.log("File exists. Use --overwrite to download anyway.")
                return file_name
        ...
        logger.log("Extracting %s" % absolute_gz_file_name)
    ...
    def get_embedding_model(
        ...
        embedding_model = {}
        logger.log("Loading embeddings. This may take a few minutes ...")
